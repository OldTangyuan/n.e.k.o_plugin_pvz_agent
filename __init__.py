...
class PVZAgentPlugin(NekoPluginBase):
    ...
    @llm_tool(
        name="pvz_start",
        description=(
            "让猫娘开始玩《植物大战僵尸》：她会自己看画面、给策略并操作游戏。"
    ...
    @llm_tool(
        ...
        description=(
            ...
            "例如'自动玩完当前这一关并尽可能取得胜利'、'这关用寒冰射手守第二行'。"
            "目标会进入她每轮决策的依据。"
        ),
        parameters={
            "type": "object",
    ...
    @llm_tool(
        ...
        description=(
            "给玩《植物大战僵尸》的自己下发一条自然语言打法引导，"
            "下一轮操作会遵循它。用于调整具体打法——给方向性指令，"
            "不提供精确坐标/步骤。例如'先种豌豆射手'、"
            "'这波优先攒阳光'、'寒冰射手放前排'、'别在(0,0)重复种，换目标'。"
        ),
        parameters={
            "type": "object",
